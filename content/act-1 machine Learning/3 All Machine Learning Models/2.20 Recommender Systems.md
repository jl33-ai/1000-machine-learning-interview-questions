...
All we need to do is **[[impute]]** the missing values. Let's just use the **average**. Now our column vectors representing podcasts 1 and 2 look like this: 
...
To finally calculate similarity, we use the following formula: 
