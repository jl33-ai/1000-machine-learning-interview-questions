...
We won't go more in detail into the core algorithms that operate at a lower level in this section - saving all of that for [[Act IV - Programming/2 Data Structures and Algorithms/2.1 Introduction|Data Structures and Algorithms]]. 
