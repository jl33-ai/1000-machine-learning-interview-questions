...
We won't go more in detail into the core algorithms that operate at a lower level in this section - saving all of that for [[act-4 coding/2 Neetcode/2.1 Introduction|Data Structures and Algorithms]]. 
