...
> - `sklearn` gives you the ability to use any of the machine learning models covered in [[2.0 Preface|this section]]
...
###### ↳ By referring to this hierarchy, can you please write an import statement for importing and [[2.2 Object Oriented Programming|instantiating]] a Support Vector Classifier under the alias of `AwesomeSVC`?
...
It's a little bit [[2.1 Software Development#What does 'obsfucated' mean|obsfucated]], but hopefully this clarifies the internal structure of `sklearn`. 
